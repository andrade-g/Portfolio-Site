    ...
    return (
        <header className="header">
            ...
            <nav className="social-media">
                <a href="https://www.linkedin.com/in/glhrm-andrade" target="_blank" rel="noreferrer">
                ...
                <a href="https://www.behance.net/guilherme-andrade" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-behance"
                        viewBox="0 0 16 16">
                        <path
                ...
                <a href="https://www.instagram.com/glhrm.andrade" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
